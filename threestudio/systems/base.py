...
from threestudio.data.multiview import MultiviewsDataModuleConfig
...
class BaseLift3DSystem(BaseSystem):
    ...
    class Config(BaseSystem.Config):
        ...
        seg_list: List[str] = field(default_factory=lambda: [])
        seg_softmax_list: Optional[List[int]] = None
        
        test_sh_degree: int = 3
        
        
        seg_prompt_processor: dict = field(default_factory=dict)
        
        edit_prompt: str = "" 
        edit_prompt_processor: dict = field(default_factory=dict)
        ...
        # obj_list: List[int] = field(default_factory=lambda: [])
        edit_obj_list: List[int] = field(default_factory=lambda: [])
        ply_path: Optional[str] = None
        if_segment: bool = True
        if_gen: bool = True
        edit_part_index: List[int] = field(default_factory=lambda: [])
        im23D : bool = False
        img_path : Optional[str] = None
        
        recon_path : Optional[str] = None
        if_fine_edit: bool = False
        if_recon: bool = False
        edit_angle: int = 0
        seed : int = 0
        data: Optional[MultiviewsDataModuleConfig] = None
        spo_path:str = ""
